...
Identify the active job from `.xoch/work/current.md` or legacy `.xoch/context/current.md`. Gather requirements, clarify scope, acceptance criteria, constraints, docs, risks, and current-state impact.
