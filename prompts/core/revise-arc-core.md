...
description: Full reference workflow for xoch-revise-arc
---

# Xoch - Revise Arc Core

This is the full reference workflow for `xoch-revise-arc`. It is rendered to `~/.xoch/prompts/core/revise-arc-core.md` and is not installed as a command.
