---
name: xoch-glossary-core
description: Full reference workflow for xoch-glossary
---

# Xoch - Glossary Core

This is the full reference workflow for `xoch-glossary`. It is rendered to `~/.xoch/prompts/core/glossary-core.md` and is not installed as a command.
