...
Before starting this command, run `xoch job current --json`. This reads the canonical `.xoch/work/current.json` pointer and migrates a target-model `.xoch/work/current.md` pointer when encountered.
